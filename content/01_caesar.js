      ...
      "python": [
        {
          ...
          "content": "Diese Funktion prüft, ob der gegebene String nur Charaktere aus dem Alphabet, also Buchstaben, enthält."
        },
        {
          "title": "<code>ord()</code>",
          "content": "Diese Funktion gibt die Zahl des Unicode-Codes eines Zeichens zurück. Beispiel: <code>ord(\"h\")</code> gibt <code>104</code> zurück."
        },
        {
          "title": "<code>chr()</code>",
          "content": "Diese Funktion gibt das Unicode-Zeichen zurück, das durch diese Nummer repräsentiert wird. Beispiel: <code>chr(104)</code> gibt <code>\"h\"</code> zurück."
        }
      ],
      "javascript": [
        {
          "title": "<code>String.prototype.isAlpha()</code>",
          "content": "Diese Methode prüft, ob der gegebene String nur Charaktere aus dem Alphabet, also Buchstaben, enthält."
        },
        {
          "title": "<code>String.prototype.charCodeAt()</code>",
          "content": "Diese Methode gibt den Unicode-Wert des Zeichens an der angegebenen Position zurück. Beispiel: <code>\"h\".charCodeAt(0)</code> gibt <code>104</code> zurück."
        },
        {
          "title": "<code>String.fromCharCode()</code>",
          "content": "Diese Funktion gibt das Unicode-Zeichen zurück, das durch diese Nummer repräsentiert wird. Beispiel: <code>String.fromCharCode(104)</code> gibt <code>\"h\"</code> zurück."
        },
        {
    ...
    "tasks": [
      ...
      },
      {
        ...
        "helpers": [
          {
            "title": "Formulierungshilfen",
            "content": "<ul><li>Bei einer Verschiebung um 32 Zeichen wird der Buchstabe...</li><li>...wird das Unicode-Zeichen an der Stelle ... ausgegeben.</li><li>Ein Problem könnte entstehen, wenn...</li><li>Um das Problem zu lösen, müsste der Code...</li></ul>"
          }
        ]
      },
      {
