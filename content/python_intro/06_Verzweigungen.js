worksheets.push({
  titleShort: "pythonVerzweigungen",
  titleTechnical: "pythonVerzweigungen",
  title: "Wenn es nicht nur eine Option gibt: Komplexe Verzweigungen in Python",
  description:
    "<p>Genau wie beispielsweise bei Parkzonen im Straßenverkehr gibt es auch beim Programmieren manchmal nicht nur eine oder zwei Möglichkeiten, sondern verschiedene Verzweigungen.</p><p>Um weitere Bedingungen zu einer <code class='code-dark'>if</code>-Anweisung hinzuzufügen, verwendet man in Python das Schlüsselwort <code class='code-dark'>elif</code> (Abkürzung für <em>else if</em>).</p>",
  ...
  code: {
    python:
      'a = input("Gib hier einen Wochentag ein:")\nif a == "Samstag" or a == "Sonntag":\n    print("Wochenende!")\nelif a == "Freitag":\n    print("Fast Wochenende!")\nelse:\n    print("Noch ein Arbeitstag.")',
  },
  codeFilename: {
    python: "pythonVerzweigungen.py",
  },
